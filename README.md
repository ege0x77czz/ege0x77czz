...
<a href="https://discord.com/users/egekralcan">
  <img src="https://img.shields.io/badge/discord-egekralcan-5865F2?style=for-the-badge&logo=discord&logoColor=white" />
</a>
...
fn main() {
    let ege = human {
        ...
        pronouns: "he/him",
        location: "türkiye",
        vibes: vec!["coding", "rust", "low-level stuff"],
        status: "building cool shit",
    };
    
    loop {
        ege.write_code();
        ege.learn_something_new();
    }
}
```
